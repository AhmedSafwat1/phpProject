<?php
    ...
    class Validation extends Model{
        ...
        /*
        * check unique from databse
        * @parm table name
        * @return this
        */
        public function Unique($tableNmae, $colum, $cond)
        {
            $this->table_name = $tableNmae;
            $data = $this->getOne($cond, $colum);
            
            if($data)
            {
                $this->errors["unique"] = "this {$this->name} alrady exist";
                return $this;
